        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-sm rounded-full border border-deep-ochre/20 mb-6">
              <Truck className="w-4 h-4 text-deep-ochre" />
          ...
          <div className="space-y-6">
              ...
              <div className="bg-warm-ivory rounded-3xl p-8 border border-deep-ochre/10">
                <h2 className="font-display text-2xl text-raw-umber mb-6 flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-deep-ochre/10 flex items-center justify-center">
                    <Truck className="w-5 h-5 text-deep-ochre" />
                  </div>
                ...
                <div className="space-y-4 text-raw-umber/70">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                    <div className="p-5 bg-gradient-to-br from-blush-dust to-warm-ivory rounded-lg border border-deep-ochre/10">
                      <h4 className="font-display text-raw-umber mb-3">Standard Shipping</h4>
                      <ul className="space-y-2 text-sm">
                        <li className="flex items-center gap-2">
                          <Clock className="w-4 h-4 text-deep-ochre" />
                          5-7 business days
                        </li>
                        <li className="flex items-center gap-2">
                    ...
                    <div className="p-5 bg-gradient-to-br from-blush-dust to-warm-ivory rounded-lg border border-deep-ochre/10">
                      <h4 className="font-display text-raw-umber mb-3">Express Shipping</h4>
                      <ul className="space-y-2 text-sm">
                        <li className="flex items-center gap-2">
                          <Clock className="w-4 h-4 text-deep-ochre" />
                          2-3 business days
                        ...
                        <li className="text-raw-umber/50 pl-6">Available for metro cities</li>
                      </ul>
                    </div>
                  </div>
                </div>
            ...
            <AnimatedSection delay={0.15}>
              <div className="bg-warm-ivory rounded-3xl p-8 border border-deep-ochre/10">
                <h2 className="font-display text-2xl text-raw-umber mb-6 flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-deep-ochre/10 flex items-center justify-center">
                    <Globe className="w-5 h-5 text-deep-ochre" />
                  </div>
                ...
                <div className="space-y-4 text-raw-umber/70">
                  ...
                  <div className="overflow-x-auto mt-6">
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="border-b-2 border-deep-ochre/20">
                          <th className="text-left py-4 px-4 font-display text-raw-umber">Region</th>
                          <th className="text-left py-4 px-4 font-display text-raw-umber">Delivery Time</th>
                          <th className="text-left py-4 px-4 font-display text-raw-umber">Starting Price</th>
                        </tr>
                      </thead>
                      <tbody>
                        {internationalRates.map((rate, i) => (
                          <tr key={i} className="border-b border-deep-ochre/10 hover:bg-blush-dust/30 transition-colors">
                            <td className="py-4 px-4 text-raw-umber">{rate.region}</td>
                            <td className="py-4 px-4 text-raw-umber/70">{rate.time}</td>
                            <td className="py-4 px-4 font-semibold text-deep-ochre">{rate.price}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                  ...
                  <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4">
                    {[
                      ...
                      <li key={i} className="flex items-start gap-2 text-sm">
                        <Sparkles className="w-4 h-4 text-deep-ochre flex-shrink-0 mt-0.5" />
                        {item}
                      </li>
                    ))}
                  </ul>
            ...
            <div className="relative bg-raw-umber p-8 md:p-12 rounded-3xl overflow-hidden">
              ...
              <div className="text-center relative">
                <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-deep-ochre/20 flex items-center justify-center">
                  <Truck className="w-7 h-7 text-deep-ochre" />
                </div>
